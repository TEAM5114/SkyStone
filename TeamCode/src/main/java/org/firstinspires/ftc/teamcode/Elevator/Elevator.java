...
public class Elevator {
    ...
    public static double SPOOL_RADIUS = 1; // inches
    public static double GEAR_RATIO = 1; // spool speed / motor speed

    public static double MAX_HEIGHT = 15; // inches
    ...
    public Elevator(HardwareMap hardwareMap) {
        ...
        // if necessary, reverse so that up is positive
